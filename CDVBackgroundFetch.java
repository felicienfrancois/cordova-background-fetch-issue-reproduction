...
public class CDVBackgroundFetch extends CordovaPlugin {
    ...
    public void onReset(Intent intent) {
        Log.d(BackgroundFetch.TAG, "[CDVBackgroundFetch] onReset");
    }
    public Bundle onSaveInstanceState() {
        Log.d(BackgroundFetch.TAG, "[CDVBackgroundFetch] onSaveInstanceState");
        return null;
    }
    public boolean onRenderProcessGone(final WebView view, RenderProcessGoneDetail detail) {
        Log.d(BackgroundFetch.TAG, "[CDVBackgroundFetch] onRenderProcessGone");
        return false;
    }
    public void onStop() {
        Log.d(BackgroundFetch.TAG, "[CDVBackgroundFetch] onStop");
    }
    ...
    private void configure(JSONObject options, final CallbackContext callbackContext) throws JSONException {
        ...
        adapter.configure(config.build(), new BackgroundFetch.Callback() {
            @Override public void onFetch(String taskId) {
                Log.d(BackgroundFetch.TAG, "[CDVBackgroundFetch] onFetch");
